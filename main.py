...
twitter_accounts: Dict[str, TwitterAccount] = {
    ...
    'woonomic': TwitterAccount(
        username='woonomic',
        language='en',
        last_tweet_id=0,
    ),
    'CryptanalystFR': TwitterAccount(
        username='CryptanalystFR',
        language='fr',
        last_tweet_id=0,
    ),
    'coinalist': TwitterAccount(
        username='coinalist',
        language='fr',
        last_tweet_id=0,
    ),
    'BTCTN': TwitterAccount(
        username='BTCTN',
        language='en',
        last_tweet_id=0,
    ),
    'cryptoastblog': TwitterAccount(
        username='cryptoastblog',
        language='fr',
        last_tweet_id=0,
    ),
    'LeJournalDuCoin': TwitterAccount(
        username='LeJournalDuCoin',
        language='fr',
        last_tweet_id=0,
    ),
}
